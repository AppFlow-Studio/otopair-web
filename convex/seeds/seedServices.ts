  ...
  handler: async (ctx) => {
    ...
    const services = [
      // Diagnostics (1-3)
      {
        ...
        display_order: 1,
        service_category_id: categories["Inspections"],
      ...
      // Routine Maintenance (6-11)
      {
        ...
        display_order: 6,
        service_category_id: categories["Routine"],
      ...
      },
      {
        ...
        display_order: 8,
        service_category_id: categories["Scheduled Service"],
      ...
      // Tires (12-15)
      {
        ...
        display_order: 12,
        service_category_id: categories["Tires & Brakes"],
        default_labor_hours: 0.4,
        is_labor_only: true,
        has_options: false,
        requires_parts: false,

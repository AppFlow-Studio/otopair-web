  ...
  if (detail === null) {
    return (
      <div className="rounded-xl border border-red-200 bg-white p-6 text-sm text-red-700">
        ...
        <Link href="/data/parts" className="font-medium text-blue-600 hover:underline">
          Back to parts
        </Link>
        .
      </div>
    ...
    <div className="space-y-6">
          ...
          {detail.supersedes && (
            <span>
              ...
              {detail.supersedes.id ? (
                <Link
                  href={`/data/parts/${detail.supersedes.id}`}
          ...
          {detail.superseded_by && (
            <span>
              ...
              {detail.superseded_by.id ? (
                <Link
                  href={`/data/parts/${detail.superseded_by.id}`}
                  className="font-mono text-blue-600 hover:underline"
                >
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-5">
        ...
        <p className="mt-3 text-[11px] text-slate-400">
          ...
          <Link href="/data/parts-pricing" className="text-blue-600 hover:underline">
            Parts Pricing
          </Link>

    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-border bg-card">
        ...
        <div className="flex items-start">
          ...
          >
            <div
              className={`fixed right-6 top-6 z-20 flex h-[calc(100vh-3rem)] max-h-[calc(100vh-3rem)] w-[528px] flex-col overflow-hidden rounded-xl border border-border bg-card transition-all duration-200 ease-out ${
                drawerOpen

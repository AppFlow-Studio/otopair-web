...
| Spec-leaf vocabulary | Not shared across makes — each grounded live. Honda "Standards and Service Limits"; Toyota "Service Specifications"/"…Standard Capacity"; Ford "General Specifications"/"Capacities"/"Lubricants…"; **BMW numbered "Technical Data" groups** ("11 00 ENGINE" = oil fill, "17 00 COOLING", "34 11 Front Brakes" MIN TH); Nissan "Engine Oil/Coolant Capacity"; Ram/Chevrolet "Capacities And Recommended Fluids"/"Approximate Fluid Capacities" + region-labelled schedules. |
| Wrong-market deny list | Grows per maker vocabulary: Honda "General Countries"/"(Ecuador)", Chrysler/Ram "Middle East"/"LATIN AMERICA", BMW "Collision -" body-panel subtree (not wrong-market, but 9/12 slots of gap-dimension junk). |
| Seven-make verification | Specs harvest verified live on Honda, Toyota, Ford, BMW, Nissan, Ram, Chevrolet. Labor populated on Honda CR-V EX AWD (12) and BMW 330i (10 — its bleed leaf carries hours); Altima/Ram/Equinox labor indexes are 1.6–2 KB stubs → honest no_matches. |
